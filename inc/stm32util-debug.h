...
#if defined(DEBUG)
#	if !defined(STM32UTIL_DEBUG_ON)
#		define STM32UTIL_DEBUG_ON	1
#	endif
#	if !defined(STM32UTIL_ASSERT_ON)
...
#if STM32UTIL_DEBUG_ON && STM32UTIL_DEBUG_LEVEL_PRINTF <= STM32UTIL_DEBUG_LEVEL
#define PRINTF(...)		DBG_WRAP( printf(__VA_ARGS__) )
#else
#define PRINTF(...)
#endif

#if STM32UTIL_DEBUG_ON && STM32UTIL_DEBUG_LEVEL_DPRINTF <= STM32UTIL_DEBUG_LEVEL
...
#if STM32UTIL_DEBUG_ON && STM32UTIL_DEBUG_LEVEL_ERROR <= STM32UTIL_DEBUG_LEVEL
...
#if STM32UTIL_DEBUG_ON && STM32UTIL_DEBUG_LEVEL_WARNING <= STM32UTIL_DEBUG_LEVEL
...
#if STM32UTIL_DEBUG_ON && STM32UTIL_DEBUG_LEVEL_TRACE <= STM32UTIL_DEBUG_LEVEL
